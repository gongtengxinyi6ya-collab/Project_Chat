...
public:
    ...
    RepoResult upserDirectOnMessage(const std::string&senderAccountId,const std::string&receiverAccountId,const std::string&senderUsername,uint64_t msgId,const std::string& preview,uint64_t serverTsMs)override;//私聊消息发送成功落库后，更新发送方和接收方的会话行
